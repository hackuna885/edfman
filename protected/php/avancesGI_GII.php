...
date_default_timezone_set('America/Mexico_City');
		...
		###################
		$cantidadR3 = $con -> query("SELECT COUNT(id) AS totalR2a FROM nom035R2a ");

		while ($usrR2 = $cantidadR3->fetchArray()) {
			$totalR2a = $usrR2['totalR2a'];
		}

		$tolFaltanR2a = $totUsr - $totalR2a;
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 mx-auto" style="height: 950px;">
				...
				<div class="row py-3">
					<div class="col-md-6 mx-auto">
						<h5>Cantidad de Capturas vs Total de Colaboradores Guía II</h5>
						<div class="mx-auto text-center m-3">
						...
						<div class="row">
							...
							<thead class="bg-primary text-white">
								...
								<tbody>
									...
									<tr>
										<td>Total de colaboradores que SI realizaron Guía II:</td>
										<td class="text-success"><b><?php echo $totalR2a; ?></b></td>
									</tr>
									
									<tr>
										<td>Total de colaboradores que NO realizaron Guía II:</td>
										<td><b class="text-danger"><?php echo $tolFaltanR2a; ?></b></td>
									</tr>
								</tbody>
							</table>
					...
					<div class="col-md-6 mx-auto">
						<h5>Colaboradores que SI realizaron Guía II</h5>
						<div class="row">
							<table class="table table-hover col-12 mx-auto m-3 table-sm">
								<thead class="bg-primary text-white">
									<tr>
								...
								<tbody style="font-size: .5em;">
										...
										<?php 
											...
											$colSi = $con -> query("SELECT usrNumEmp_R2a,usrNombre_R2a,Corporativo,Puesto FROM nom035R2a INNER JOIN dataEmpleadosInt WHERE usrNombre_R2a = Nombre ORDER BY Corporativo,usrNombre_R2a,Puesto");
											$i=0;

											while ($usrSi = $colSi->fetchArray()) {
												$i++;
												$usrNumEmp_R2a = $usrSi['usrNumEmp_R2a'];
												$usrNombre_R2a = $usrSi['usrNombre_R2a'];
												$corporativo = $usrSi['Corporativo'];
												$puesto = $usrSi['Puesto'];
					...
					<div class="col-md-6 mx-auto">
						<h5>Colaboradores que NO realizaron Guía II</h5>
						<div class="row">
							<table class="table table-hover col-12 mx-auto m-3 table-sm">
								<thead class="bg-primary text-white">
									<tr>
								...
								<tbody style="font-size: .5em;">
										...
										<?php 
											...
											$colSi = $con -> query("SELECT NumEmpleado,Nombre,Corporativo,Puesto FROM dataEmpleadosInt WHERE Nombre NOT IN(SELECT usrNombre_R2a FROM nom035R2a) ORDER BY Corporativo,Nombre,NumEmpleado,Puesto");
											$i=0;
		...
		var chart = new Chart(ctx, {
		    ...
		    data: {
		        ...
		        datasets: [{
		        	...
		        	backgroundColor: ['#B0DD65', '#F55069'],
		            borderColor: ['#B0DD65', '#F55069'],
		            data: [<?php echo $totalR2a; ?>, <?php echo $tolFaltanR2a; ?>]
		        }]
		    },
