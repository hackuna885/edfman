...
<div class="marcoP">
        <table style="width: 2890px;">
            <thead>
                <tr>
                    <th colspan="41" rowspan="0" style="background-color: transparent; color: #1F419A;"><h2 style="text-align: center; padding: 5px; margin: 10px;">Matriz Individual GIII "<?php $_GET['centroTrab'] = (isset($_GET['centroTrab'])) ? $_GET['centroTrab'] : ''; echo $_GET['centroTrab'];?>"</h2></th>
                </tr>
            </thead>
            <thead>
                <tr>
			...
			$csE = $con -> query("SELECT * FROM matrizIndividualGIII WHERE Empresad = '$_GET[empresa]' AND carpetaPrincipal = '$_GET[centroTrab]'");
