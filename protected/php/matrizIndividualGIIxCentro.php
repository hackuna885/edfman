		 			...
		 			<div class="row">
		 				<div class="col-md-10 mx-auto text-center jumbotron">
							...
							while ($centros = $busCentros->fetchArray()) {
								...
								<tr>
									<td style="text-align: left;"><a href="../impreMatrizIndividualGIIxCentro/impre.aspx?empresa='.$empresad.'&centroTrab='.$carpetaPrincipal.'" target="_blank" rel="noopener noreferrer">'.$empresad.'</a></td>
									<td style="text-align: center;"><a href="../impreMatrizIndividualGIIxCentro/impre.aspx?empresa='.$empresad.'&centroTrab='.$carpetaPrincipal.'" target="_blank" rel="noopener noreferrer">'.$carpetaPrincipal.'</a></td>
									<td style="text-align: center;"><a href="../impreMatrizIndividualGIIxCentro/impre.aspx?empresa='.$empresad.'&centroTrab='.$carpetaPrincipal.'" target="_blank" rel="noopener noreferrer">'.$cuantos.'</a></td>
								</tr>
