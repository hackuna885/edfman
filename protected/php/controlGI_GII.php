								    		...
								    		<div class="card-body">
								    			<table class="table">
								    		 	...
								    		 	<?php 
													...
													$usrG2a = $con -> query("SELECT id,dirEmpresa_R2a,usrNombre_R2a,codeMd5_R2a,fechaHoraFinal_R2a FROM nom035R2a ORDER BY id");
													...
													while ($guiaR2a = $usrG2a->fetchArray()) {
														...
														// echo '<td class="text-left">'.$dirEmpresa_R2a.'</td>';
													...
													$usrG1aT = $con -> query("SELECT COUNT(usrNombre_R2a) AS totalCol FROM nom035R2a");
								    		...
								    		<div class="card-body">
								    			<table class="table">
								    		 	...
								    		 	<?php 
													...
													$usrG3aVsG1a = $con -> query("SELECT usrNombre_R1a FROM nom035R1a WHERE usrNombre_R1a NOT IN(SELECT usrNombre_R2a FROM nom035R2a) ORDER BY usrNombre_R1a");
													$i=0;
													...
													$usrG3aTVSG1 = $con -> query("SELECT COUNT(usrNombre_R1a) AS totalCol FROM nom035R1a WHERE usrNombre_R1a NOT IN(SELECT usrNombre_R2a FROM nom035R2a)");
								    		...
								    		<div class="card-body">
								    			<table class="table">
								    		 	...
								    		 	<?php 
													...
													$usrG1aVsG2a = $con -> query("SELECT usrNombre_R2a FROM nom035R2a WHERE usrNombre_R2a NOT IN(SELECT usrNombre_R1a FROM nom035R1a) ORDER BY usrNombre_R2a");
													$i=0;
													...
													$usrG1aTVSG3a = $con -> query("SELECT COUNT(usrNombre_R2a) AS totalCol FROM nom035R2a WHERE usrNombre_R2a NOT IN(SELECT usrNombre_R1a FROM nom035R1a)");
