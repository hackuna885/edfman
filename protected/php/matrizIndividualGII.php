		 		...
		 		<div class="bg-muted p-3" style="width: 800px;">
		 			<div class="row">
		 				<div class="col-md-10 mx-auto text-center jumbotron">
							 ...
							 <h3>Matriz Guía de Referencia II Individual por Empresa.</h3>
							...
							while ($centros = $busCentros->fetchArray()) {
								...
								<tr>
									<td style="text-align: left;"><a href="../impreMatrizIndividualGII/impre.aspx?empresa='.$empresad.'" target="_blank" rel="noopener noreferrer">'.$empresad.'</a></td>
									<td style="text-align: center;"><a href="../impreMatrizIndividualGII/impre.aspx?empresa='.$empresad.'" target="_blank" rel="noopener noreferrer">'.$cuantos.'</a></td>
								</tr>
