					...
					<div style="padding: 10px; width: 630px; height: 950px; margin: auto;">
						...
						<div style="position: absolute; margin-left: 490px; margin-top: 0px; font-size: .5em; color: grey; text-align: left;">
							...
							<table>
								<tr>
									<td>
										<img src="../soloqr.php?txtQr=http://corsec.com.mx/'.$empresa_R3a.'/impreR03/enviarResultados.aspx?correoCrypt_R3a='.$codeMd5_R3a.'" style="width: 125px;" />
									</td>
									<td style="width: 300px;">
										<p>http://corsec.com.mx/'.$empresa_R3a.'/impreR03/enviarResultados.aspx?correoCrypt_R3a='.$codeMd5_R3a.'</p>
									</td>
								</tr>
							</table>
						</div>
