		 		...
		 		<div class="bg-muted p-3" style="width: 800px;">
		 			<div class="row">
		 				<div class="col-md-10 mx-auto text-center jumbotron">
							 ...
							 <h3>Matriz Guía de Referencia III Individual por Empresa.</h3>
							...
							$busCentros = $con -> query("SELECT Empresad, COUNT(Empresad) AS cuantos FROM dataEmpleadosDos GROUP BY Empresad");
							...
							while ($centros = $busCentros->fetchArray()) {
								...
								<tr>
									<td style="text-align: left;"><a href="../impreMatrizIndividualGIII/impre.aspx?empresa='.$empresad.'" target="_blank" rel="noopener noreferrer">'.$empresad.'</a></td>
									<td style="text-align: center;"><a href="../impreMatrizIndividualGIII/impre.aspx?empresa='.$empresad.'" target="_blank" rel="noopener noreferrer">'.$cuantos.'</a></td>
								</tr>
